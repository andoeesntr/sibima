    ...
    <div className="relative py-12 px-4">
      ...
      <div className="flex justify-between relative">
        {steps.map((step, index) => (
          <div key={step.id} className="relative px-2 flex flex-col items-center" style={{ width: `${100 / steps.length}%` }}>
            {/* Circle marker */}
            ...
            <div className={`w-full ${index % 2 === 0 ? 'mt-16' : 'mt-0 -mb-12 order-first'}`}>
