...
interface GuidanceRequestDialogProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmitSuccess: () => void;
}

const GuidanceRequestDialog = ({ isOpen, onClose, onSubmitSuccess }: GuidanceRequestDialogProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Ajukan Sesi Bimbingan</DialogTitle>
        </DialogHeader>
...
export default GuidanceRequestDialog;
